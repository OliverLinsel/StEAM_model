...
* --- Define Samples ----------------------------------------------------------
	...
	msStart('invest', 's001') = 1513;
	msEnd('invest', 's001') = 1681;
	msStart('invest', 's002') = 3193;
	msEnd('invest', 's002') = 3361;
	msStart('invest', 's003') = 6049;
	msEnd('invest', 's003') = 6217;
	msStart('invest', 's004') = 169;
	msEnd('invest', 's004') = 337;
	...
	p_msWeight('invest', 's002') = 18.049451;
	p_msWeight('invest', 's003') = 9.024725;
	p_msWeight('invest', 's004') = 3.008242;

    p_msAnnuityWeight('invest', s) = 0;
    p_msAnnuityWeight('invest', 's000') = 2021.538462/8760;
    p_msAnnuityWeight('invest', 's001') = 1684.615385/8760;
    p_msAnnuityWeight('invest', 's002') = 3032.307692/8760;
    p_msAnnuityWeight('invest', 's003') = 1516.153846/8760;
    p_msAnnuityWeight('invest', 's004') = 505.384615/8760;
