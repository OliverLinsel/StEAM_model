...
optca = 100      // Absolute gap between the found solution and the best possible solution
optcr = 0.01  // Relative gap between the found solution and the best possible solution
