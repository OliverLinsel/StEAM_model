...
* --- Define Key Execution Parameters in Time Indeces -------------------------
    ...
    mSettings('invest', 't_jump') = complete_length;          // How many time steps the model rolls forward between each solve
...
* --- Define Samples ----------------------------------------------------------
    ...
    msEnd('invest', 's000') = complete_length;
...
* --- Define Time Step Intervals ----------------------------------------------
    ...
    mInterval('invest', 'lastStepInIntervalBlock', 'c000') = complete_length;
